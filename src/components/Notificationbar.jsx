...
const Notificationbar = (props) => {
  ...
  return (
    <PerfectScrollbar
      className={`${props.className} bg-secondary max-h-dvh-65 flex min-w-96 flex-col overflow-y-auto shadow-md md:h-dvh md:max-h-full md:shadow-md-right dark:shadow-gray-950`}
      style={props.style}
    >
